package com.egp.fmkotlin.ui.home.recommended
...
//    fun initDataDummmy() {
//        foodList = ArrayList()
//        foodList.add(HomeVerticalModel("Rec Cheery Healthy", "289000", "", 5f))
//        foodList.add(HomeVerticalModel("Rec Burger Tamayo", "4509000","", 4f))
//        foodList.add(HomeVerticalModel("Rec Bakwan Cihuy", "999000","", 4.5f))
//    }
